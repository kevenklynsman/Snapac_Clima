...
const feelLikeTemperature = document.getElementById("feels-like-temperature");
const currentHumity = document.getElementById("current-humidity");
const sunriseTime = document.getElementById("sunrise-time");
const sunsetTime = document.getElementById("sunset-time");

const api_key = "8d090443cdb94bf3283c98d2cb2d6b76";
...
function displayWeather(data) {
  ...
  feelLikeTemperature.textContent = `${Math.round(feels_like)}°C`;
  currentHumity.textContent = `${humidity}%`;
